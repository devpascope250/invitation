...
// import { CheckCircle, XCircle, Save, Download, ArrowLeft } from "lucide-react";
...
//     setIsDownloading(true);
//     try {
//       // Generate or get the invitation content for printing
//       const response = await fetch(`/api/generate-invitation/${invitationId}?format=print`);
//       if (!response.ok) throw new Error('Failed to generate print version');
...
//       toast.error("Failed to prepare invitation for printing", {
...
//             Review and download your invitation
//           </p>
//         </div>
...
//                 <CardDescription>
//                   Review invitation information and download
//                 </CardDescription>
//               </div>
...
//                   disabled={isDownloading || invitation.approval !== "APPROVED"}
...
//                   {invitation.approval === "PENDING"
//                     ? "Invitation must be approved before downloading."
//                     : invitation.approval === "REJECTED"
//                     ? "This invitation has been rejected and cannot be downloaded."
//                     : "Invitation is not yet approved for download."}
//                 </div>
//               )}
